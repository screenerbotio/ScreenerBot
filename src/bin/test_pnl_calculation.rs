...
fn main() -> anyhow::Result<()> {
    ...
    let mut position = Position::new("TestToken123".to_string(), "TEST".to_string());
    ...
    position.add_buy_trade(investment, tokens_bought, entry_price, None);
