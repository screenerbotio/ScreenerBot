...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    log(LogTag::Pool, "DEBUG", "This is a debug message (should only appear if ENABLE_POOL_DEBUG_LOGS = true)");
    ...
    log(LogTag::Pool, "INFO", "Note: Debug logs are controlled by ENABLE_POOL_DEBUG_LOGS constant in pool_price.rs");
