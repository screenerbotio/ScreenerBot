...
// ═══════════════════════════════════════════════════════════════════════════════
//
// This module has been split into smaller, more maintainable files:
// - config.rs: All configuration constants and parameters
// - pump_analysis.rs: Fast pump detection and momentum analysis
// - price_analysis.rs: Real-time price analysis and calculations
// - entry.rs: Entry decision logic (should_buy function)
// - dca.rs: Dollar-cost averaging logic (should_dca function)
// - exit.rs: Exit decision logic (should_sell function)
// - position.rs: Position management and evaluation
// ═══════════════════════════════════════════════════════════════════════════════
