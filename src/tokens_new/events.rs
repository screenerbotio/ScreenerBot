...
#[derive(Debug, Clone)]
pub enum TokenEvent {
    TokenDiscovered { mint: String, source: String, at: DateTime<Utc> },
    TokenUpdated { mint: String, at: DateTime<Utc> },
    DecimalsUpdated { mint: String, decimals: u8, at: DateTime<Utc> },
    PoolsUpdated { mint: String, best_pool: Option<String>, at: DateTime<Utc> },
    TokenBlacklisted { mint: String, reason: String, at: DateTime<Utc> },
    TokenUnblacklisted { mint: String, at: DateTime<Utc> },
}
