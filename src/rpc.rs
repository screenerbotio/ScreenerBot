...
const MAX_RPC_CALLS_PER_SECOND: u64 = 10;
        ...
        if is_debug_rpc_enabled() {
            log(
                ...
                &format!(
                    ...
                    crate::utils::safe_truncate(token_account, 12),
                    current_url
                )
            );
        }
                                        ...
                                        if is_debug_rpc_enabled() {
                                            log(
                                                ...
                                                &format!(
                                                    ...
                                                    crate::utils::safe_truncate(owner_str, 12),
                                                    current_url
                                                )
                                            );
                                        }
        ...
        if is_debug_rpc_enabled() {
            log(
                ...
                &format!(
                    ...
                    crate::utils::safe_truncate(transaction_signature, 12),
                    current_url
                )
            );
        }
