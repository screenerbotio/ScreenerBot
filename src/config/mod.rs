...
pub use schemas::{
    ...
    LockscreenConfig, MonitoringConfig, OhlcvConfig, PositionsConfig, RpcConfig, ServicesConfig,
    SolPriceConfig, StartupConfig, SwapsConfig, TelegramConfig, TimeUnit, TokensConfig,
